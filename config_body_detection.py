...
DATASET = 'body_detection'

''' Set the hyperparameters for the model you want to train or test '''
H = 512
W = 512
size = (H, W)
batch_size = 32 #limit is 18 for 255x255 images and 4 for 512x512 images
num_epochs = 100
lr = 1e-4
...
AUGMENTED_DATA_BASE_PATH = 'augmented_data/new_data_' + "body_detection" + "_"+  str(255) +  "/"
