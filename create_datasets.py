...
INPUT: 
    image_files : path to the folder containing the images
    mask_files : path to the folder containing the masks
OUTPUT: 
...
''' 
Function to empty the folders, must be done if you want to shuffle the data over again of change the split
'''
def empty_folders():
